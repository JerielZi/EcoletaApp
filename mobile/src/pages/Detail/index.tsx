...
const Detail = () => {
  ...
  return (
    ...
    <View style={styles.container} >
      ...
      <Text style={styles.pointName}>Mercado de Algés. </Text>
      <Text style={styles.pointItems}>Resíduos organicos, Baterias e Pilhas</Text>
   
      <View style={styles.address}>
        <Text style={styles.addressTitle}>Endereço</Text>
        <Text style={styles.addressContent}>Lisboa</Text>
      </View>
   </View>
